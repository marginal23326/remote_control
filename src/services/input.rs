use windows::Win32::UI::Input::KeyboardAndMouse::{
    ...
    MOUSEEVENTF_RIGHTDOWN, MOUSEEVENTF_RIGHTUP, MOUSEEVENTF_WHEEL, MOUSEEVENTF_HWHEEL, VIRTUAL_KEY,
    VK_SHIFT, VK_CONTROL, VK_MENU, VK_LWIN, VK_RETURN, VK_BACK, VK_TAB, VK_ESCAPE, 
    VK_SPACE, VK_UP, VK_DOWN, VK_LEFT, VK_RIGHT, VK_HOME, VK_END, VK_PRIOR, VK_NEXT,
    VK_INSERT, VK_DELETE, VK_SNAPSHOT, VK_F1, VK_F2, VK_F3, VK_F4, VK_F5, VK_F6, VK_F7,
...
impl InputManager {
    pub fn new() -> Self {
        ...
        Self { screen_width: width, screen_height: height }
    }
    ...
    pub fn click_mouse(&self, button: &str, pressed: bool) {
    ...
    pub fn scroll_mouse(&self, dx: i32, dy: i32) {
        // Vertical Scroll
        if dy != 0 {
    ...
    pub fn send_shortcut(&self, key: &str, modifiers: Vec<String>) {
    ...
    fn map_key_to_vk(&self, key: &str) -> VIRTUAL_KEY {
        match key.to_lowercase().as_str() {
            ...
            "enter" | "return" => VK_RETURN, "backspace" => VK_BACK, "tab" => VK_TAB,
            "esc" | "escape" => VK_ESCAPE, "space" => VK_SPACE,
            "up" => VK_UP, "down" => VK_DOWN, "left" => VK_LEFT, "right" => VK_RIGHT,
            "home" => VK_HOME, "end" => VK_END, "pageup" => VK_PRIOR, "pagedown" => VK_NEXT,
            "insert" => VK_INSERT, "delete" => VK_DELETE, "printscreen" => VK_SNAPSHOT,
