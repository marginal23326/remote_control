import { streamUI } from "@/features/stream/view.js";
import { streamActive } from "@/features/stream/stream-state.js";
import { calculateStreamDimensions } from "@/features/stream/geometry.js";
import { sendMouseEventOverDataChannel } from "@/features/stream/peer-connection.js";
import { captureState } from "./capture-state.js";

function initializePointerInput(socket) {
